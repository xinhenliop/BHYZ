        ...
        <div class="table-data" style="margin-top: 10px;">
            ...
            {{--<div class="panel table-statistics">
                <div class="line line1 divcontainer">
                    ...
                    <p class="table-statistics-text">充值</p>
                </div>
                <div class="line">
                    <p class="table-statistics-number recharge">0</p>
                </div>
            </div>--}}
            <div class="panel table-statistics">
                <div class="line line1 divcontainer">
            ...
            <div class="panel table-statistics">
                <div class="line line1 divcontainer">
                    ...
                    <p class="table-statistics-text">App</p>
                </div>
                <div class="line">
...
<script>
    ...
    layui.use(['element', 'layer', "form", "laydate"], function () {
        ...
        function tu_today() {
            $.get("?m=statistics.user_chart&today=" + $(".tu-today").val(), function (response) {
                var data = response;
                if (data.code === 200) {
        ...
        function to_today() {
            $.get("?m=statistics.user_total&today=" + $(".today").val(), function (response) {
        ...
        bing_today("user_app", "bing");
        bing_today("user_status", "bing2");
        tu_today();
        to_today();
    });
    //头部事件
