                ...
                <div class="layui-card-body layui-card-crad">
                    <div class="layer-body" style="padding: 10px;">
                        <div class="layer-body">
                            <p class="one-title title">日志管理</p>
                            ...
                            <div>
                                ...
                                <script type="text/html" id="stateHtml">
                                    <p name="logData" class="">@{{d.log_msg}}</p>
                                </script>
    ...
    layui.use(['element', 'dropdown', 'layer', 'util', 'table'], function () {
        ...
        table.render({
            ...
            , cols: [[
                ...
                , {field: 'log_users', width: 200, title: '日志用户'}
                , {field: 'log_level', width: 200, title: '标题'}
                , {field: 'log_msg', minWidth: 200, title: '内容', templet: '#stateHtml'}
