...
<div class="layui-bg-gray" style="padding: 30px;">
    <div class="layui-card layer-crad" style="">
        <div class="layui-card-body layui-card-crad">
            @if(!isset($error))
                <p class="Lay-Title title">卡密创建</p>
                    ...
                    <span
                        ...
                        <form class="layui-form" id="example" onsubmit="return false" style="margin-top: 10px;">
                            ...
                            @if($request->input("user",0) == 0)
                                ...
                                <div class="layui-form-item">
                                    <p class="form-title">制作数量</p>
                                    <input style="width: 200px" type="number" step="0.01" name="count"
                                           lay-verify="required|number" autocomplete="off" value="0"
                                           placeholder="生成卡密数量！" class="created-input">
                                    <label>生成卡密数量！</label>
                                </div>
                                ...
                                <div class="layui-form-item">
                                    ...
                                    <input style="width: 200px" type="text" name="prefix" lay-verify="required"
                                           autocomplete="off" value="" placeholder="@lang('type.prefix_hint')"
                                           class="created-input">
                                    <label>分类生成卡密前缀，不需要可留空！</label>
                                </div>
                            @else
                                <div class="layui-form-item">
                                    <p class="form-title" style="margin-top: 8px;">@lang('type.app')</p>
                                ...
                                <div class="layui-form-item">
                                    <p class="form-title">用户账号</p>
                                    <input style="width: 300px" type="text" name="user" lay-verify="required"
                                           autocomplete="off" value="" class="created-input">
                                    <label>新建用户账号</label>
                                </div>

                                <div class="layui-form-item">
                                    <p class="form-title">用户密码</p>
                                    <input style="width: 300px" type="text" name="password" lay-verify="required"
                                           autocomplete="off" value="" class="created-input">
                                    <label>新建用户密码</label>
                                </div>
...
<script>
    ...
    layui.use(['element', 'layer', 'util', "form"], function () {
        ...
        $(".created-button").on("click", function () {
            ...
            if (formData.indexOf("type_uid=&") > 0) {
                layer.alert('分类不可为空');
                return;
            }
            if (formData.indexOf("count=&") > 0) {
                layer.alert('名称不可为空');
                return;
            }
            $.post({
